...
export const ModalSubmitJob = ({ setShowModal, submitJob }) => {
                    ...
                    <form className="p-4 md:p-5">
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2">
                                ...
                                <textarea onChange={handleSelect} name="notes" id="description" rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write job notes here"></textarea>
                            </div>
                        </div>
                        {/* Showing btn based on input */}
                        {showBtn ? <button onClick={() => { setShowModal(false); submitJob(jobFields) }} type="submit" className=" bg-lime-500 w-full hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Submit new job
                        </button> : null}
